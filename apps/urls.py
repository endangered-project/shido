...
urlpatterns = [
    ...
    path('instance/<int:instance_id>/add_property/', instance_add_property_list, name='apps_instance_add_property_list'),
    path('instance/<int:instance_id>/add_property/<int:property_type_id>/', instance_add_property_form, name='apps_instance_add_property'),
